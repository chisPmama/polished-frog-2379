...
def test_data
  ...
  DoctorPatient.create!(doctor: @mark, patient: @patient3)
  ...
  DoctorPatient.create!(doctor: @cristina, patient: @patient2)


  DoctorPatient.create!(doctor: @derek, patient: @patient1)
